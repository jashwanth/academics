    set sopc "c:/altera/12.0/quartus//sopc_builder"
    set sopc_perl "c:/altera/12.0/quartus//bin/perl"
...
if { [ string match "*ModelSim ALTERA*" [ vsim -version ] ] } {
 alias _init_setup {vlib work
                       ...
                       vcom -93 -explicit c:/altera/12.0/quartus/libraries/vhdl/altera/altera_europa_support_lib.vhd
		       } } else {
 alias _init_setup {vlib work
                       vmap altera               work
                       vmap arriaii_hssi         work
                       ...
                       vcom -93 -explicit c:/altera/12.0/quartus/libraries/vhdl/altera/altera_europa_support_lib.vhd
                       vcom -93 -explicit c:/altera/12.0/quartus/eda/sim_lib/altera_mf_components.vhd
                       vcom -93 -explicit c:/altera/12.0/quartus/eda/sim_lib/altera_mf.vhd
                       vcom -93 -explicit c:/altera/12.0/quartus/eda/sim_lib/220pack.vhd
                       vcom -93 -explicit c:/altera/12.0/quartus/eda/sim_lib/220model.vhd
                       vcom -93 -explicit c:/altera/12.0/quartus/eda/sim_lib/sgate_pack.vhd
                       vcom -93 -explicit c:/altera/12.0/quartus/eda/sim_lib/sgate.vhd
                       } } 
...
# We account for that here.
if { [ string match "*ModelSim ALTERA*" [ vsim -version ] ] } {
 alias _vsim {vsim -t ps +nowarnTFMPC  -L lpm -L altera -L altera_mf -L sgate -L stratixiv -L stratixiv_hssi -L stratixiv_pcie_hip -L stratixv_ver -L stratixv_hssi_ver -L stratixv_pcie_hip_ver -L altera_lnsim -L stratixv -L stratixv_hssi -L stratixv_pcie_hip test_bench }  } else {
...
alias s "_init_setup
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/LED_S.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/jtag_uart_0.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/cpu_0_test_bench.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/cpu_0_oci_test_bench.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/cpu_0_jtag_debug_module_tck.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/cpu_0_jtag_debug_module_sysclk.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/cpu_0_jtag_debug_module_wrapper.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/cpu_0.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/switches.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/onchip_memory2_0.vhd
vcom -93 -explicit C:/Users/Jashwanth/Desktop/4th_sem/altera/sopc_builder/nios_system.vhd
_vsim
do virtuals.do
set StdArithNoWarnings 1
; test_contents_files"
alias r "exec $sopc_perl/bin/perl -I $sopc/bin/perl_lib -I $sopc/bin $sopc/bin/run_command_in_unix_like_shell.pl $sopc { cd ../;  ./nios_system_generation_script  } "
alias c "echo {Regenerating memory contents.
 (This may take a moment)...}; restart -f; exec $sopc_perl/bin/perl -I $sopc/bin/perl_lib -I $sopc/bin $sopc/bin/run_command_in_unix_like_shell.pl $sopc { cd ../;  ./nios_system_generation_script  }  --software_only=1"
...
proc s_cycloneiv {} {
  if { [ expr ! [ string match "*ModelSim ALTERA*" [ vsim -version ] ] ] } {
    vlib work
    _init_setup
    set qsimlib c:/altera/12.0/quartus/eda/sim_lib
    set vhd_files [ list \
