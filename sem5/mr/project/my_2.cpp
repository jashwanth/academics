...
//	bc.setRobotVelocity_idle(200,200);
	argv[1]="-rrtp";
	argv[2]="8102";
	argc=3;
...
//	bc.setRobotVelocity_idle(100,100); // initialising vr and vl
	bc.setRobotVelocity(100,100, 1000);
...
//bc1.setRobotVelocity(100,100, 10000);
        bc1.moveRobot(5000,0);
//bc1.setRobotVelocity(100,100, 30000);
bc1.moveRobot(600,90);
//bc1.moveRobot(0,90);
	argv[1]="-rrtp";
	argv[2]="8103";	
	argc=3;
...
bc5.getAngles(5);*/
 ArUtil::sleep(5000);
         		bc1.setRobotVelocity_idle(180,150);
