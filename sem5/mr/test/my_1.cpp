...
//  ArActionGoto gotopose("goto", ArPose(2000.0, 3000.0, 0.0), 100, 400,150,7);
...
//  robot.addAction(&gotopose,80);
  ...
  robot.addAction(&go, 80);
  robot.addAction(&turn,80);
  // Enable the motors, disable amigobot sounds
  robot.enableMotors();
/*  while(!gotopose.haveAchievedGoal())
  {
    robot.lock();
    ArUtil::sleep(300);
    robot.unlock();
